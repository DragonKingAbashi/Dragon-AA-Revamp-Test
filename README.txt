...
- DragonAARevampConfig.cs: Example of ModConfig for custom mod settings;
- DragonAARevampGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- DragonAARevampMain.cs: Main mod class, recieves mod management and general events;
- DragonAARevampTactical.cs: Example of ModTactical for modifying tactical level;
