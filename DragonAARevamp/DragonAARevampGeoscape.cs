...
namespace DragonAARevamp
{
	...
	public class DragonAARevampGSInstanceData
	{
	...
	/// </summary>
	public class DragonAARevampGeoscape : ModGeoscape
	{
		/// <summary>
		...
		public override object RecordGeoscapeInstanceData() {
			return new DragonAARevampGSInstanceData() { ExampleData = 5 };
		}
		/// <summary>
		...
		public override void ProcessGeoscapeInstanceData(object instanceData) {
			DragonAARevampGSInstanceData data = (DragonAARevampGSInstanceData)instanceData;
		}
