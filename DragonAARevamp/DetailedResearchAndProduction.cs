            ...
            public static void Postfix(UITooltipText __instance, GameObject ____widget)
            {
                try
                {
                    ...
                    if (__instance.TipKey.LocalizationKey == "KEY_RESEARCH_TOTAL_TT")
                    {
                        ...
                        string add = "";
                        if (DragonAARevamp.Settings.EnableFacilityAdjustments && DragonAARevamp.Settings.ResearchLabGenerateTechAmount > 0f)
                        {
                    ...
                    else if (__instance.TipKey.LocalizationKey == "KEY_PRODUCTION_TOTAL_TT")
                    {
                        ...
                        string add = "";
                        if (!(!Settings.EnableFacilityAdjustments || DragonAARevamp.Settings.FabricationPlantGenerateMaterialsAmount <= 0f))
                        {
