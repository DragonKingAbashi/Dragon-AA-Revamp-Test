...
namespace DragonAARevamp
{
	...
	public class DragonAARevampTacInstanceData
	{
	...
	/// </summary>
	public class DragonAARevampTactical : ModTactical
	{
		/// <summary>
		...
		public override void OnTacticalStart() {
			...
			DragonAARevampMain main = (DragonAARevampMain)Main;
		}
		/// <summary>
		...
		public override void ProcessTacticalInstanceData(object instanceData) {
			DragonAARevampTacInstanceData data = (DragonAARevampTacInstanceData)instanceData;
		}
		/// <summary>
		...
		public override object RecordTacticalInstanceData() {
			 return new DragonAARevampTacInstanceData() { ExampleData = 5 };
		}
		/// <summary>
