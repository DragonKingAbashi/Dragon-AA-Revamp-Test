...
namespace DragonAARevamp
{
    internal static class UnlockItemsByResearch
    {
        ...
        public static void Init()
        {
            ...
            if (DragonAARevamp.Settings.UnlockPhoenixEliteGear)
            {
                UnlockConfigurations.Add(PhoenixEliteGear);
            }
            if (Settings.UnlockLivingWeapons)
            {
                UnlockConfigurations.Add(LivingWeapons);
            }
            if (Settings.UnlockLivingArmor)
            {
                UnlockConfigurations.Add(LivingArmor);
            }
            if (Settings.UnlockIndependentAmmunition)
            {
                UnlockConfigurations.Add(IndependentAmmunition);
            }
            if (Settings.UnlockIndependentWeapons)
            {
                UnlockConfigurations.Add(IndependentWeapons);
            }
            if (Settings.UnlockIndependentArmor)
            {
                UnlockConfigurations.Add(IndependentArmor);
            }
            if (Settings.UnlockHiddenItem)
            {
